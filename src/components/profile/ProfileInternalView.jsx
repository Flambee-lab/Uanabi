...
export default function ProfileInternalView({
  ...
  const headline =
    categories.length > 0 ? categories.join(' · ') : 'Creadora de viajes'

  const hasBrandChips = verifiedBrands.length > 0 || pastCollabBrands.length > 0
  const showExperience = hasBrandChips || pastEvents.length > 0

  return (
    <div className="uanabi-page overflow-y-auto">
      <div className="mx-auto max-w-5xl px-6 pb-14 pt-6 sm:px-10">
        <section className="uanabi-panel overflow-hidden px-5 pb-6 pt-5 sm:px-6 sm:pt-6">
          <ProfileAvatar
          ...
          <div className="mt-4">
            <div className="flex flex-wrap items-center gap-2">
              ...
              {profile.isConfigured && (
                <Badge className="gap-1 bg-emerald-50 text-emerald-800 hover:bg-emerald-50">
        ...
        <div className="mt-4 space-y-4">
          ...
          {showExperience && (
            ...
            >
              {hasBrandChips && (
                <div className={pastEvents.length > 0 ? 'mb-5 border-b border-border-subtle pb-5' : undefined}>
                  <div className="flex flex-wrap items-center gap-2">
