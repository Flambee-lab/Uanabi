        ...
        <div className="px-8 py-8">
          {success ? (
            ...
            <div className="space-y-6">
              ...
              <textarea
                className="w-full rounded-xl border border-border bg-secondary px-4 py-3 text-sm text-foreground focus:border-primary focus:bg-white focus:outline-none disabled:opacity-60"
                rows={3}
