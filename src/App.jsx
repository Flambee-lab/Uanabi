    ...
    <div className="flex min-h-full flex-col items-center justify-center bg-[#fafafa] px-6 py-12">
      <div className="w-full max-w-md rounded-3xl border border-neutral-100 bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-center text-xs leading-relaxed text-neutral-500">
          El archivo <code className="text-neutral-700">.env.local</code> existe, pero todavía no
        ...
        <ol className="mt-6 space-y-4 text-left text-xs text-neutral-600">
          ...
          <li className="flex gap-3">
            ...
            <span>
              En <strong>Project Settings → API</strong>, copiá la{' '}
          ...
          <li className="flex gap-3">
            ...
            <span>
              En <strong>SQL Editor</strong>, pegá y ejecutá el contenido de{' '}
          ...
          <li className="flex gap-3">
            ...
            <span>
              En <strong>Authentication → URL Configuration</strong>, agregá{' '}
          ...
          <li className="flex gap-3">
            ...
            <span>
              <strong>Reiniciá</strong> el servidor (<code className="text-neutral-800">npm run dev</code>)
